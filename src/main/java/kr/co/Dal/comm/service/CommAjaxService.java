...
public class CommAjaxService {
     ...
     * @return
     */
    public int commReplyStepMax(ReplyVO replyVO) {
        return commMapper.commReplyStepMax(replyVO);
    }

    /**
     * 댓글을 중간에 적었을 때 이미 작성된 replyStep 업데이트하기
     */
    public void commReplyStepUpdate(ReplyVO replyVO) {
        commMapper.commReplyStepUpdate(replyVO);
    }
